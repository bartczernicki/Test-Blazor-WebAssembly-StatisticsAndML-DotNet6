...
is a test Blazor WASM (WebAssembly) with .NET Core 3.x, .NET 5 & .NET 6 implemintations, that showcases howto perform statistical analysis locally inside the browser.
